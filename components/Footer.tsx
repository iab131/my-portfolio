  ...
  return (
    <footer className="w-full bg-slate-900 text-white">
      ...
      <section className="relative h-screen overflow-hidden">
        ...
        {/* ── Content wrapper — we nudge it down with pt-24 ── */}
        <div className="relative z-10 flex flex-col items-center pt-[30vh]">
          ...
          <div className="max-w-6xl mx-auto px-6 text-center space-y-8">
            ...
            <span className="text-sm sm:text-md text-slate-400 mt-2 block">
              ...
              <span className="underline font-semibold">enhebai@uwaterloo.ca</span>
            </span>
          </div>
      ...
      <div className="absolute inset-x-0 bottom-10 px-6">
        <div className="container mx-auto flex flex-col md:flex-row items-center justify-between gap-8 text-sm text-slate-400">
